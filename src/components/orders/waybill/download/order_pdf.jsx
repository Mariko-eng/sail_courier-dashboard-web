...
const DownloadWaybillOrderPdfButton = ({ orderId }) => {
  ...
  const link = `${backendUrl}/api/main/orders-waybill/items/list/${orderId}/pdf-download/`;
...
export default DownloadWaybillOrderPdfButton;