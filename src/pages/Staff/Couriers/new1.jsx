          ...
          try {
            if (scriptedRef.current) {
              ...
              if (fileBase64 === "") {
                ...
                // Check if there was an error in the couriersStore after dispatch
                if (couriersStore.error) {
                  console.log("couriersStore.error 1");
                  throw new Error(couriersStore.error);
                }
                ...
                if (list.length >= 2) {
                  ...
                  // Check if there was an error in the couriersStore after dispatch
                  if (couriersStore.error) {
                    console.log("couriersStore.error 2");
                    throw new Error(couriersStore.error);
                  }
