...
import {Box, Paper, Typography, Menu, MenuItem, Collapse } from '@mui/material';
...
const columns = [
  ...
  { id: 'parcelSenderName', label: 'Sender Name', minWidth: 150 },
  { id: 'parcelSenderPhone', label: 'Sender Phone', minWidth: 150 },
  ...
  { id: 'createdByEmail', label: 'Client Account', minWidth: 100 },
          ...
          <>
            ...
            >
              <MenuItem
                onClick={() => {
                  handleCloseMenuActions();
                  navigate(`/orders/regular/detail/${selectedRow.id}`);
                }}
              >
                View Order
              </MenuItem>
